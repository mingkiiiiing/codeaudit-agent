...
| A3_flood_task_table | ✅ OK | 60 空任务，表上限=44；F5 准入：25 路接纳 20/拒 429×5/峰值 active=20 |
| A4_churn | ✅ OK | 30 轮抖动；幽灵 DELETE=[404, 404, 405, 404] |
| A5_sse_flood | ✅ OK | 100/100 收流；首字节 p95=1230.6ms |
| A6_oversize_upload | ✅ OK | 210MB→413；RSS 峰值=660.3MB；60MB×3 e2e p50=1535.3ms |

## 场景明细

### A7_sandbox_escape ｜ ✅ OK ｜ 场景耗时 6.32s

| 校验 | 结果 | 说明 |
|---|---|---|
| timeout_kill | ✅ | timed_out=True dur=2.059 |
...
### A1_malicious_zips ｜ ✅ OK ｜ 场景耗时 36.92s
...
| server_alive_after_arsenal | ✅ | {'status': 'ok', 'version': '0.5.0', 'audits': {'active': 0, 'total': 2}} |
...
| server_alive | ✅ | {'status': 'ok', 'version': '0.5.0', 'audits': {'active': 0, 'total': 2}} |
...
### A3_flood_task_table ｜ ✅ OK ｜ 场景耗时 60.72s

| 校验 | 结果 | 说明 |
|---|---|---|
| table_capped_at_50 | ✅ | total=44（FIFO 淘汰应把终态表压回 ≤50） |
...
| server_alive | ✅ | {'status': 'ok', 'version': '0.5.0', 'audits': {'active': 0, 'total': 1}} |

```json
{
  "flood_count": 60,
  "upload_wall_sec": 1.81,
  "terminals": {
    "done": 42
  },
  "health_after_flood": {
...
| table_not_leaking | ✅ | {'status': 'ok', 'version': '0.5.0', 'audits': {'active': 0, 'total': 1}} |
...
| server_alive | ✅ | {'status': 'ok', 'version': '0.5.0', 'audits': {'active': 1, 'total': 2}} |
...
| f2_rss_no_blowup | ✅ | 210MB 上传前后当前工作集增量 +3.7MB（阈值 <50MB；历史峰值 660.3MB 仅为进程生命周期参考） |
...
```json
{
  "oversize": {
    "status": 413,
    "wall_sec": 3.46,
    "server_rss_before_mb": 94.7,
    "server_rss_after_mb": 98.4,
    "server_rss_peak_mb": 660.3,
    "server_rss_delta_mb": 3.7
  },
  "fat_60mb": {
    "zip_kb": 60.0,
    "e2e_ms_p50": 1535.3,
