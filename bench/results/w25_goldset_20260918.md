...
- 生成时间：2026-09-18T16:06:01+00:00
- 严重度层级：critical+high
- 项目数：10
...
|---|---|
| n | 10 |
| sec_per_kloc_p50 | 2.11 |
| sec_per_kloc_p90 | 3.2424 |
| sec_per_kloc_mean | 2.7379 |

### 分项目明细

| 项目 | LOC | 耗时(s) | s/KLOC | Issue 数 |
|---|---|---|---|---|
| demo_proj | 142 | 1.36 | 9.59 | 15 |
| blogengine | 215 | 0.43 | 1.99 | 13 |
| blogengine_inj | 336 | 0.47 | 1.41 | 42 |
| datatools | 286 | 0.42 | 1.48 | 23 |
| datatools_inj | 396 | 0.63 | 1.58 | 57 |
| demo_proj_inj | 277 | 0.70 | 2.54 | 52 |
| shopcore | 276 | 0.65 | 2.36 | 16 |
| shopcore_inj | 407 | 0.87 | 2.14 | 50 |
| webapi | 239 | 0.53 | 2.22 | 13 |
