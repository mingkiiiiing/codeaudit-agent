...
| A5_sse_flood | ✅ OK | 100/100 收流；首字节 p95=1105.9ms |
| A6_oversize_upload | ✅ OK | 210MB→413；RSS 峰值=660.0MB；60MB×3 e2e p50=1332.1ms |

## 场景明细

### A7_sandbox_escape ｜ ✅ OK ｜ 场景耗时 7.18s

| 校验 | 结果 | 说明 |
|---|---|---|
| timeout_kill | ✅ | timed_out=True dur=2.285 |
...
### A1_malicious_zips ｜ ✅ OK ｜ 场景耗时 31.43s
...
| server_alive_after_arsenal | ✅ | {'status': 'ok', 'version': '0.6.0', 'audits': {'active': 0, 'total': 0}} |
...
### A3_flood_task_table ｜ ✅ OK ｜ 场景耗时 54.38s
...
| f2_rss_no_blowup | ✅ | 210MB 上传前后当前工作集增量 +1.2MB（阈值 <50MB；历史峰值 660.0MB 仅为进程生命周期参考） |
...
```json
{
  "oversize": {
    "status": 413,
    "wall_sec": 2.84,
    "server_rss_before_mb": 98.4,
    "server_rss_after_mb": 99.7,
    "server_rss_peak_mb": 660.0,
    "server_rss_delta_mb": 1.2
  },
  "fat_60mb": {
    "zip_kb": 60.0,
    "e2e_ms_p50": 1332.1,
